  ...
  <div id="reset-mail">
    <b-container>
      ...
      <b-row>
        ...
        <b-col cols="10">
          <h4>一直没有收到邮件？</h4>
          <p>请先检查是否在垃圾邮件中。如果还未收到，请&nbsp;&nbsp;&nbsp;&nbsp;<span class="mail-again">点击重新发送邮件</span></p>
        </b-col>
      </b-row>
    </b-container>
  </div>
...
<script>
  export default {
    ...
    methods: {
      fetchData(){
        this.mailPage = this.$route.query.page;
        // this.mailPage=decodeURIComponent(this.$route.query.page);
        this.email = this.$route.query.email;
      },
      viewMail() {
        // this.$router.push('/reset-activate');
        if (!this.mailPage) {
          this.$toast.success({
