    ...
    <b-container fluid>
      <b-row>
        <b-col cols="9" class="left">
          <b-row class="data-board">
            <b-col cols=3>
              <b-card>
                <b-media class="today-ns-count">
                  <h5 class="mt-0">今日建站数</h5>
                  <b-media>
                    <img src="../../../assets/imgs/today-ns-count.png"/>
                    <h5 class="mt-0">{{groupCount['web_today_num']}}</h5>
                  </b-media>
                </b-media>
              </b-card>
            </b-col>
            ...
            <b-col cols=3>
              <b-card>
                <b-media class="site-amount">
                  <h5 class="mt-0">总站点数</h5>
                  <b-media>
                    <img src="../../../assets/imgs/site-amount.png"/>
                    <h5 class="mt-0">{{groupCount['web_total']}}</h5>
                  </b-media>
                </b-media>
              </b-card>
            </b-col>
            ...
            <b-col cols=3>
              <b-card>
                <b-media class="new-member-count">
                  <h5 class="mt-0">今日新增成员</h5>
                  <b-media>
                    <img src="../../../assets/imgs/new-member-count.png"/>
                    <h5 class="mt-0">{{groupCount['user_today_num']}}</h5>
                  </b-media>
                </b-media>
              </b-card>
            </b-col>
            ...
            <b-col cols=3>
              <b-card>
                <b-media class="member-amount">
                  <h5 class="mt-0">总成员</h5>
                  <b-media>
                    <img src="../../../assets/imgs/member-amount.png"/>
                    <h5 class="mt-0">{{groupCount['user_total']}}</h5>
                  </b-media>
                </b-media>
              </b-card>
            </b-col>
                ...
                <b-col cols="11">
                  <b-row>
                    <b-col cols="6" class="switch">
                      <span class="menu" @click="showChart=!showChart" title="站点列表"></span>
                    </b-col>
                      ...
                      <div id="site-list">
                        <b-row>
                          ...
                          <b-col cols="8" class="input-div">
                            <input type="text" v-model="search" placeholder="请输入站点域名或站点名称" @change="queryData">
                        ...
                        <b-row>
                          <b-form-group id="input-group-4" style="text-align: left;margin: 25px;">
                            <b-form-checkbox-group id="checkboxes-4">
                              <b-form-checkbox v-for="item in sites" :key="item.id" v-model="web_ids" :value="item.id">
                                {{item.domain}}
                              </b-form-checkbox>
  ...
  export default {
    ...
    methods: {
      ...
      getTargetSiteStatistics() {
        ...
        http.getTargetSiteStatistics(body).then(rs => {
          if (!rs.code) {
            that.chartData = {
              x: [],
              PV: [],
      ...
      getGroupNormalSite() {
        ...
        http.getGroupNormalSite(params).then(rs => {
          if (!rs.code) {
            this.sites = rs.data;
      ...
      getGroupSatistics() {
        http.getGroupSatistics().then(rs => {
          if (!rs.code) {
            this.groupCount = rs;
          }
        });
...
<style lang="scss" scoped>
  ...
  .today-ns-count, .site-amount, .new-member-count {
    margin-right: 40px;
  }
