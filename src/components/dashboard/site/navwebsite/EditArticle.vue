        ...
        <b-col cols="12">
          <table cellpadding="12">
            <tr>
              ...
              <td>
                <!-- <b-form-select v-model="article['category_id']" :options="options"></b-form-select> -->
                <treeselect v-model="article['category_id']" style="width: 180px;" :multiple="false" :options="options" />
              </td>
            </tr>
            <tr>
              <td>文章标题:<span style="color:red;">*</span></td>
              <td>
            ...
            <tr>
              <td>文章标签:</td>
              <td>
                <b-form-select v-model="article['tags']" :options="tag" multiple :select-size="3"></b-form-select>
              </td>
            </tr>
            <tr>
              <td>文章主图:<span style="color:red;">*</span></td>
              <td>
            ...
            <tr>
              <td style="vertical-align: baseline;">文章内容:<span style="color:red;">*</span></td>
              <td>
            ...
            <tr>
              <td>链接:</td>
              <td><input type="text" v-model="article.url"></td>
            </tr>
            <tr>
              <td>SEO配置</td>
              <td></td>
            ...
            <tr>
              ...
              <td><textarea name="" v-model="article['seo_keywords']"></textarea></td>
            </tr>
            <tr>
              <td style="vertical-align: baseline;">描述:</td>
              <td><textarea name="" v-model="article['seo_description']"></textarea></td>
            </tr>
          </table>
          <div style="padding-left: 25%;">
            <b-button @click="createArticle()">确定</b-button>
        ...
        <b-col cols="12">
          <table cellpadding="12">
            <tr>
              <td>栏目:<span style="color:red;">*</span></td>
              <td>
                <!-- <b-form-select v-model="update['category_id']" :options="options"></b-form-select> -->
                <treeselect v-model="update['category_id']" style="width: 180px;" :multiple="false" :options="options" />
              </td>
            </tr>
            <tr>
              <td>文章标题:<span style="color:red;">*</span></td>
            ...
            <tr>
              <td>文章标签:</td>
              <td>
                <b-form-select v-model="update['tags']" :options="tag" multiple :select-size="3"></b-form-select>
              </td>
            </tr>
            <tr>
              <td>文章主图:<span style="color:red;">*</span></td>
            ...
            <tr>
              ...
              <td>
                ...
                <!-- <quill-editor id="update_editor" ref="myTextEditor" v-model="update.content"
                              :options="editorOption"></quill-editor> -->
              </td>
            </tr>
            <tr>
  ...
  export default {
    ...
    methods: {
      ...
      createArticle() {
        ...
        formData.append("seo_keywords", this.article['seo_keywords']);
        formData.append("seo_description", this.article['seo_description']);
        if(this.article['tags'].length===1 && !this.article['tags'][0]){
          formData.append('tags', '');
        }else{
          for (let i = 0; i < this.article['tags'].length; i++) {
            formData.append('tags[]', this.article['tags'][i]);
          }
        }
        formData.append("url", this.article['url']);
        http.createArticle(formData).then(rs => {
          if (!rs.code) {
             this.$toast.success({
            message:"保存成功！",
            color:'#3cb5f1'
      ...
      updataArticle() {
        ...
        if(this.update['tags'].length===1 && !this.update['tags'][0]){
          formData.append('tags', '');
        }else{
          for (let i = 0; i < this.update['tags'].length; i++) {
            formData.append('tags[]', this.update['tags'][i]);
          }
        }
        formData.append("url", this.update['url']);
        http.updataArticle(formData).then(rs => {
          if (!rs.code) {
             this.$toast.success({
            message:"保存成功！",
            color:'#3cb5f1'
      ...
      getArticleDetail() {
        http.getArticleDetail({id: this.updateId}).then(rs => {
          if (!rs.code) {
            let temp = rs;
