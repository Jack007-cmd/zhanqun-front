<template>
  <div id="keyword-replace">
    <b-container fluid>
      <b-row>
        <b-col cols="12" class="plate-title">
          ...
          <b-button class="btn-add" v-b-modal.modal-add-keyword>新增+</b-button>
        </b-col>
      </b-row>
      <b-row>
        <b-col cols="11" class="data-items">
          ...
          <b-row v-for="(item,index) in items" :key="item.id">
            ...
            <b-col cols="2">
              <b-button @click="toEdit(item)">编辑</b-button>
    ...
    <b-modal id="modal-edit-keyword" size="xs" centered hide-header hide-footer>
      <div class="div-edit-keyword">
        <h5>新增/编辑</h5>
        ...
        <div style="padding-left: 80px;">
          ...
          <b-button @click="$bvModal.hide('modal-edit-keyword')">返回</b-button>
        </div>
      </div>
    </b-modal>
