        ...
        <b-col cols="11" class="mtb30">
          ...
          <div class="site-items">
            ...
            <b-row v-for="(item,index) in siteItems" :key="item.id">
              ...
              <b-col cols="1"><input type="number" style="width: 40px;" min="0" v-model="item.sort" @change="updateNavWebsiteSort(item.id,item.sort)"></b-col>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      update(id){
        this.$router.push("/dashboard/site/nw-edit-website?type=2&id="+id);
      },
      toEdit() {
        this.$router.push("/dashboard/site/nw-edit-website?type=1");
      },
      linkGen(pageNum) {
