    ...
    <b-container fluid>
      <b-row>
        <b-col cols="12" class="plate-switch">
          ...
          <span :class="{on:plate==='c'}" @click="plate='c'">公告</span>
      ...
      <b-row v-if="plate==='a'" class="base-info">
        <b-col cols="12">
          ...
          <b-button style="display: block; margin-left: 35%;" @click="updateBasicInfo">确定</b-button>
        </b-col>
      </b-row>
      ...
      <b-row v-if="plate==='c'" class="base-info">
        <b-col cols="12">
          <table cellpadding="12">
            <tr>
...
<style lang="scss" scoped>
  ...
  .base-info, .customer-service, .other-config {
    padding-top: 30px;
