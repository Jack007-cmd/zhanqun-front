        ...
        <b-col cols="11" class="mtb30">
          ...
          <div class="site-items">
            ...
            <b-row v-for="(item,index) in articleItems" :key="item.id">
              ...
              <b-col cols="2" :title="item.name"><p>{{item.name}}</p></b-col>
              <b-col cols="2">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toEdit() {
        this.$router.push("/dashboard/site/journal-atlas-add?type=1");
      },
      update(id) {
        this.$router.push("/dashboard/site/journal-atlas-add?type=2&id=" + id);
      },
      linkGen(pageNum) {
