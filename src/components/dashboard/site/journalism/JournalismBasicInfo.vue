              ...
              <td>
                <tr>
                  ...
                  <label class="btn btn-orange" for="white_logo"
                        style="display:inline-block;width: 70px;padding: 0;text-align: center;line-height: 28px;">
                    <img src="../../../../assets/imgs/upload.png" height="70" width="113"/></label>
                  <input type="file" id="white_logo" :value="imgFile" style="position:absolute; clip:rect(0 0 0 0);"
                        accept="image/png, image/jpeg, image/gif, image/jpg" @change="chooseImg($event, 1,basic,'white_logo')">
                  <img v-lazy="basic['white_logo_img']" :key="basic['white_logo_img']" alt=""
                      style="margin-left:50px;width: 100px;height: 70px;vertical-align: top;">
                </tr>
                <tr>
                  <span style="width:45px;display: inline-block;">移动端</span>
          ...
          <table cellpadding="10">
            ...
            <tr>
              ...
              <td>
                ...
                <input type="file" id="upload" :value="imgFile" style="position:absolute; clip:rect(0 0 0 0);"
                       accept="image/png, image/jpeg, image/gif, image/jpg" @change="chooseImg($event, 1,config,'kefu_wechat_code')">
