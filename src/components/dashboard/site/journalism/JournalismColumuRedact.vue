  ...
  export default {
    ...
    methods: {
      ...
      createCategory(){
        ...
        http.createAtlasCategory(this.create).then(rs=>{
          if(!rs.code){
             this.$toast.success({
            message:"保存成功！",
            color:'#3cb5f1'
      ...
      updateCategory(){
        ...
        http.updateAtlasCategory(this.update).then(rs=>{
          if(!rs.code){
             this.$toast.success({
            message:"保存成功！",
            color:'#3cb5f1'
      ...
      getAtlasCategoryDetail(id){
        http.getAtlasCategoryDetail({id:id}).then(rs=>{
          if(!rs.code){
            this.update = rs;
          }
        });
    ...
    mounted(){
      ...
      if(this.$route.query.id){
        this.getAtlasCategoryDetail(this.$route.query.id);
      }
    }
  }
</script>
