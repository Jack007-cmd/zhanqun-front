        ...
        <b-col cols="11" class="mtb30">
          <b-row>
            <b-form inline>
              ...
              <div class="input-group">
                <input type="text" class="form-control"  placeholder="请输入文章标题" v-model="search" @change="queryData">
          ...
          <div class="site-items">
            ...
            <b-row v-for="(item,index) in articleItems" :key="item.id">
              ...
              <b-col cols="4" :title="item.title"><p>{{item.title}}</p></b-col>
              <b-col cols="2">
              ...
              <b-col cols="3">
                ...
                <b-button class="toTop" v-if="item['is_top']===1" @click="cancelArticleTop(item.id)"
                          style="width: 80px;">取消置顶
                </b-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toEdit() {
        this.$router.push("/dashboard/site/ns-article-add?type=1");
      },
      update(id) {
        this.$router.push("/dashboard/site/ns-article-add?type=2&id=" + id);
      },
      linkGen(pageNum) {
