<template>
  <div id="nav-sort-manage">
    <b-container fluid>
      <b-row>
        <b-col cols="12" class="plate-title">
          <span class="on">导航页分类</span>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toEdit() {
        this.$router.push("/dashboard/site/ns-nav-edit-sort?type=1");
      },
      update(id) {
        this.$router.push("/dashboard/site/ns-nav-edit-sort?type=2&id="+id);
      },
      getNavCategoryList() {
