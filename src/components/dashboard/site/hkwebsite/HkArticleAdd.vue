        ...
        <b-col cols="12">
          <table cellpadding="12">
            ...
            <tr>
              <td>文章标签:</td>
              <td>
                <b-form-select v-model="article['tags']" multiple :select-size="3" :options="tag"></b-form-select>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><textarea name="" v-model="article['seo_keywords']"></textarea><i>注：一般不超过100个字符，关键词用英文逗号隔开</i></td>
            </tr>
            <tr>
              <td style="vertical-align: baseline">描述:</td>
              <td><textarea name="" v-model="article['seo_description']"></textarea><i>注：一般不超过200个字符</i></td>
            </tr>
          </table>
          ...
          <table cellpadding="12">
            ...
            <tr>
             ...
             <tr>
              <td>文章标签:</td>
              <td>
                <b-form-select v-model="update['tags']" multiple :select-size="3" :options="tag"></b-form-select>
              </td>
            </tr>
            <tr>
              <td>主图:<span style="color:red;">*</span></td>
