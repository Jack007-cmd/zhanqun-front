        ...
        <b-col cols="11" class="mtb30">
          <b-row>
            <b-form inline>
              ...
              <div class="input-group">
                <input type="text" class="form-control" placeholder="请输入案例名称" v-model="search" @change="queryData">
          ...
          <div class="site-items">
            <b-row>
              ...
              <!-- <b-col cols="1">分类</b-col> -->
              <b-col cols="1">主图</b-col>
              <b-col cols="3">案例名称</b-col>
            ...
            <b-row v-for="(item,index) in articleItems" :key="item.id">
              ...
              <b-col cols="3" :title="item.title"><p>{{item.title}}</p></b-col>
...
import * as http from '../../../../../apis/site'
  ...
  export default {
    ...
    methods: {
      ...
      // },
      toEdit() {
        this.$router.push("/dashboard/site/company-case-add?type=1");
      },
      update(id){
        this.$router.push("/dashboard/site/company-case-add?type=2&id=" + id);
      },
      linkGen(pageNum) {
