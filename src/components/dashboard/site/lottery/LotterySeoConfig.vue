        ...
        <b-col cols="11" class="mtb30">
          <b-row>
            <b-form inline>
              <div class="input-group">
                <input type="text" class="form-control" placeholder="请输入彩种名称" v-model="search" @change="queryData">
          ...
          <div class="leaf-items">
            <b-row>
              ...
              <b-col cols="2">彩种名称</b-col>
              <b-col cols="3">关键词</b-col>
              <b-col cols="3">描述</b-col>
            ...
            <b-row v-for="(item,index) in leafItems" :key="item.id">
              ...
              <!--8	 updated_at	修改时间-->
              <b-col cols="2">{{item.id}}</b-col>
              <b-col cols="2">{{item.name}}</b-col>
              <b-col cols="3"><div class="seo_item">{{item.keywords}}</div></b-col>
              <b-col cols="3"><div class="seo_item">{{item.description}}</div></b-col>
              <b-col cols="2">
  ...
  export default {
    ...
    methods: {
      ...
      getLeafList() {
        ...
        http.getLotterySeoList(params).then(rs => {
          if (!rs.code) {
